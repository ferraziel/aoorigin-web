<template>
  <div class="container">
    ...
    <section v-if="statusOrderAO20 == 'success'">Tu orden de compra esta siendo procesada correctamente. Si compraste un item sera depositado en la boveda, Si compraste un personaje asegurate de tener un slot de personaje disponible.</section>
