<template>
  <div class="container">
    ...
    <section v-if="statusOrderAO20 == 'success'">Tu orden de compra esta siendo procesada correctamente, pronto recibiras un email con instrucciones. Recorda que tu item sera depositado en la boveda</section>
