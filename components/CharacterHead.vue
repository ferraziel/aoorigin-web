...
<script>
import headCoords from "@/assets/head_coords.json";
...
export default {
  ...
  computed: {
    head() {
      return headCoords.find((h) => h.id === this.id);
    },
  },
};
</script>
